...
<div style="width: 100%; display: table;">
	<div style="display: table-row; position: right;">
        <div style="width: 75%; display: table-cell;"> 
			<b>Lead Computer Vision Engineer</b> <br /> 
			<a href="https://polybee.co" target="_blank"> Polybee </a>
			<ul>
			<li>Transitioning core computer vision modules to production-grade systems by architecting proper CI/CD pipelines and automated regression tests
			<li>Redesigned system architecture for modularity, to further improve accuracy and optimize cost</li>
			<li>Supporting deployment of drone operations, by interacting with customer and validating flight paths</li>
			</ul>
		</div>
	...
	<div style="display: table-row; position: right;">
        <div style="width: 75%; display: table-cell;"> 
			<b>Senior Research Engineer / Perception Team Lead</b> <br /> 
			<a href="https://opteran.com" target="_blank"> Opteran </a>
			<ul>
			<li>Developed Visual Inertial Odometry and depth sensing solutions</li>
			<li>Maintained spherical vision codebase and real-time software visual stabilisation</li>
			<li>Led the perception team</li>
			</ul>
		</div>
	...
	<div style="display: table-row; position: right;">
        <div style="width: 75%; display: table-cell;"> 
			<b>Research Scientist / Neuromorphic systems and robotic perception</b> <br /> 
    ...
    <div style="display: table-row; position: right;">
        <div style="width: 75%; display: table-cell;"> 
			<b>Research Scientist / Event-based vision and neuromorphic processing</b> <br /> 
    ...
    <div style="display: table-row; position: right;">
        <div style="width: 75%; display: table-cell;"> 
			<b>PhD student in bio-inspired robotics</b> <br /> 
...
<div style="margin: 1.5% 1.5%;">
	...
	<ul>
	  <li>Advanced: C++, Python, Pytorch</li>
	  <li>Proficient in: C, Matlab, LaTeX, VBA (macro Excel) </li>
	</ul>
 	
	<b>Tooling</b>
	<ul>
	  <li>Database: Metabase, Supabase, Sqlite </li>
	  <li>Cloud: Google cloud Storage&Computing, Azure, AWS </li>
	...
	<ul>
	  ...
	  <li>Linux programming: ROS/ROS2, Git, bash, gcc, cmake</li>
	</ul>
