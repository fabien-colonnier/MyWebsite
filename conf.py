...
BLOG_AUTHOR = "Fabien Colonnier"  # (translatable)
BLOG_TITLE = "Fabien Colonnier"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://fabien-colonnier.com/"  # "https://fabien-colonnier.github.io/MyWebsite/"
...
# (translatable)
INDEX_PATH = "AutoIndex_NOTUSED"		#needed to avoid conflicts
...
CONTENT_FOOTER = 'Contents &copy; {date}         <a author</a>     {license}'
